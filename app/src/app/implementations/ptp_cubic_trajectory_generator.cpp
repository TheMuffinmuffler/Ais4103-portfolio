...
//
#include "ptp_cubic_trajectory_generator.h"
...
void PTPCubicTrajectoryGenerator::stop()
{
    m_stopped = true;
}


bool PTPCubicTrajectoryGenerator::has_reached_endpoint() const
{
    return m_current == m_total || m_stopped;
}

bool PTPCubicTrajectoryGenerator::plan_trajectory(const Simulation::JointLimits &limits, double velocity_factor)
{
